...
How to run:
make a plr_inbox folder on user on mac
then just go to the eyessef_modified, in my case it's: cd "/Users/ptrckhanzel/Documents/SSEF Related/eyeSSEF_modified"
then just
